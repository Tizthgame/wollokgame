...
//si la posicion x del personaje es mayor a la posicion x del enemigo, el enemigo avanza a la derecha 
    if(personaje.position().x() < position.x() and position.left(1).x() != -1){
